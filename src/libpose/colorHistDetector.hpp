...
class ColorHistDetector : public Detector
{
  ...
  private:
    ...
    LimbLabel generateLabel(BodyPart bodyPart, Frame *frame, map <int32_t, Mat> pixelDistributions, map <int32_t, Mat> pixelLabels, Point2f j0, Point2f j1, float _useCSdet, float resizeFactor);
};

...
//                                float shouldBeDist = computeJointCost(labels[partIter->getPartID()].at(i), labels[partIter->getPartID()].at(i), params, true);
//                                float shouldBeZero = computeJointCost(labels[partIter->getPartID()].at(i), labels[partIter->getPartID()].at(i), params, false);

//                                Point2f p0,p1;
//                                labels[partIter->getPartID()].at(i).getEndpoints(p0,p1);

//                                float theDist = sqrt(pow(p0.x-p1.x, 2)+pow(p0.y-p1.y, 2));

//                                assert(shouldBeDist == theDist && shouldBeZero == 0);

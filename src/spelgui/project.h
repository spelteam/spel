...
namespace posegui {
  ...
  signals:
    ...
    public slots:
      ...
      //void onParametersUpdated(std::map<std::string, float> P);
        void onParametersUpdated(std::map<std::string, std::map<std::string, float>> P);
    private slots :
  ...
  public:
    ...
    void setGroupedParameters(std::map<std::string, std::map<std::string, float>> parameters);
    void saveGroupedParameters();
    void loadGroupedParameters();

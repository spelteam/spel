...
namespace SPEL
{
  ...
  */
  ...
  TEST(DetectorTests, detect)
  {
    ...
    TestSequence sequence(params, "speltests_TestData/SurfDetectorTestsData/C/", "skier.xml");
    ...
    vector<Frame*> Pattern = projectPattern.getFrames();
    Skeleton SkeletonPattern = Pattern[1]->getSkeleton(); //Copying the manually marked skeleton
    ...
    frames[1]->setSkeleton(SkeletonPattern);
    map<uint32_t, vector<LimbLabel>> Labels;
    long detect_t0 = clock();
    Labels = detector.Detector::detect(frames[1], params, Labels, detectorHelper);
    ...
    string OutputFileName = "DetectTest_DetectorHelper.txt";
    ...
    cout << "Detect: " << detect_t1 - detect_t0 << " ms\n";

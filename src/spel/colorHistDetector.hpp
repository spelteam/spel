...
{  
  ...
  public:
    ...
    /// <summary>Trains the specified_frames.</summary>
  ...
  private:
    ...
    std::map <int32_t, cv::Mat> buildPixelLabels(const Frame *frame,
    ...
    float compare(const BodyPart &bodyPart, const Frame *frame, 
